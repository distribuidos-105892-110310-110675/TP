...
function add-server-service() {
  ...
  add-line $compose_filename '      - MENU_ITEMS_CL_AMOUNT=2'
  add-line $compose_filename '      - STORES_CL_AMOUNT=2'
  add-line $compose_filename '      - TRANSACTION_ITEMS_CL_AMOUNT=2'
  add-line $compose_filename '      - TRANSACTIONS_CL_AMOUNT=2'
  add-line $compose_filename '      - USERS_CL_AMOUNT=2'
  add-line $compose_filename '    networks:'
  add-line $compose_filename '      - custom_net'
