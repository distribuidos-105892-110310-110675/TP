...
class JoinTransactionsWithUsers:
    ...
    def __init_mom_base_data_consumer(
        ...
        self._mom_base_data_consumer = RabbitMQMessageMiddlewareQueue(
    ...
    def __init__(
        ...
        controller_id: int,
        rabbitmq_host: str,
        base_data_consumer_queue_prefix: str,
        ...
        self.__init_mom_base_data_consumer(
            rabbitmq_host,
            base_data_consumer_queue_prefix,
        )
    ...
    def _join_with_base_data(self, message: str) -> str:
        ...
        for stream_item in stream_data:
            was_joined = False
            stream_user_id = int(float(stream_item["user_id"]))
            for base_item in self._base_data:
                base_user_id = int(float(base_item["user_id"]))
                if base_user_id == stream_user_id:
