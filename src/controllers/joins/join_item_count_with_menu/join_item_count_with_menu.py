...
class JoinItemCountWithMenu:
    ...
    def __init_mom_data_connection(self, host: str, consumer_queue_prefix: str) -> None:
        queue_name = f"{consumer_queue_prefix}-{self._cleaner_id}"
    ...
    def __init__(
        ...
        self._cleaner_id = controller_id
    ...
    def __handle_menu_items(self, message: str) -> None:
        logging.debug(f"Received item: {message}")
